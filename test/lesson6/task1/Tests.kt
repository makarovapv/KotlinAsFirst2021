...
class Tests {
    ...
    fun dateStrToDigit() {
        ...
        assertEquals("", dateStrToDigit("23 adadad 123131"))
    ...
    fun dateDigitToStr() {
        ...
        assertEquals("", dateDigitToStr("abf.02.duuuuuuude"))
    ...
    fun flattenPhoneNumber() {
        assertEquals("04", flattenPhoneNumber("04"))
    ...
    fun mostExpensive() {
        ...
        assertEquals("", mostExpensive("Вино 234 255.0"))
